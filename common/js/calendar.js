...
function highlightSelect()
{
	...
	if(this.className=='selectBoxTime'){
		...
		this.getElementsByTagName('IMG')[0].src = pathToImages + 'calendar/down_time_o.gif';
	...
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = pathToImages + 'calendar/down_o.gif';
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		...
		if(this.src.indexOf('left')>=0)this.src = pathToImages + 'calendar/left_o.gif';
		if(this.src.indexOf('right')>=0)this.src = pathToImages + 'calendar/right_o.gif';
	}
}
...
function highlightClose()
{
	if(this.src.indexOf('over')>=0){
		...
		this.src = pathToImages + 'calendar/close_o.gif';
	}
